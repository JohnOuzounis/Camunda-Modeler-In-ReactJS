...
- Deploy BPMN diagrams to Camunda Cockpit(camunda engine needs to be running, the deployed diagrams can be found in http://localhost:8080/engine-rest
